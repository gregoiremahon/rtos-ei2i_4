...
static void vLed_R_Task( void *pvParameters );
static void vLed_V_Task( void *pvParameters );
static void vLed_B_Task( void *pvParameters );
static void vChange_Rythme_B_Task( void *pvParameters );
 

void vInit_myTasks( UBaseType_t uxPriority )
{

		xTaskCreate( vLed_R_Task, "LEDR", ( ( unsigned short ) 90 ), 0, uxPriority, 	                                               ( TaskHandle_t * ) 0 );

	  xTaskCreate( vLed_V_Task, "LEDV", ( ( unsigned short ) 90 ), 0, uxPriority,  	                                               ( TaskHandle_t * ) 0 );

	  xTaskCreate( vLed_B_Task, "LEDB", ( ( unsigned short ) 90 ), 0, uxPriority,  	                                               ( TaskHandle_t * ) 0 );

	  xTaskCreate( vChange_Rythme_B_Task, "CHGB", ( ( unsigned short ) 90 ), 0, uxPriority,	                                               ( TaskHandle_t * ) 0 );
