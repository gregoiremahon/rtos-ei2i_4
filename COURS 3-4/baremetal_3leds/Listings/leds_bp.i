...
{switch(mae_R)
	{case 0:
		if(cpt1==0) {mae_R=1;cpt1=700;if (0) {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = 1<<22;} else {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = 1<<22;};}
	 break;
	 case 1:
		if(cpt1==0) {mae_R=0;cpt1=300;if (1) {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = 1<<22;} else {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = 1<<22;};}
     break;		
	}
}
...
void tache_scrutation_bouton(void)
{static unsigned char old_bouton;
 unsigned char bouton;
	bouton = ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN)&(1<<10))?1:0;
  if(old_bouton && !bouton) 
	 {switch (reload_B)
      {	 case 900:reload_B = 400;break; 
         case 400:reload_B = 233;break; 
         case 233:reload_B = 150;break; 
		     case 150:reload_B = 900;break; 
	   }
	}
  old_bouton=bouton;	 
}	
...
{((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR =0x01;
	if(cpt1) cpt1--;
 if(cpt2) cpt2--;
 if(cpt3) cpt3--;
...
{ ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP  |= (1 << 1);  
  ...
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR0 =100; 
