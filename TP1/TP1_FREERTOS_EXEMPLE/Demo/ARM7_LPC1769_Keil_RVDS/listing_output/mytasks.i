...
void vInit_myTasks( UBaseType_t uxPriority )
{
		...
		xTaskCreate( vLed1Task, "LED1", ( ( unsigned short ) 100 ), &argument, uxPriority, ( TaskHandle_t * ) 0 );
	  xTaskCreate( vLed2Task, "LED2", ( ( unsigned short ) 100 ), 0, uxPriority, ( TaskHandle_t * ) 0 );
	  xTaskCreate( vLed3Task, "LED3", ( ( unsigned short ) 100 ), 0, uxPriority, ( TaskHandle_t * ) 0 );
	  xTaskCreate( vLed4Task, "LED4", ( ( unsigned short ) 100 ), 0, uxPriority, ( TaskHandle_t * ) 0 );
}
 
void allume_num_tache(unsigned char num)
{   if(num&0x04) {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR = 1<<26;} else {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR = 1<<26;}
	  if(num&0x02) {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR = 1<<25;} else {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00060) )->FIOCLR = 1<<25;}
	  if(num&0x01) {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = 1<<22;} else {((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR = 1<<22;}
}

void vLed1Task( void *pvParameters )
{ static unsigned char var_static_fonction =0;
	unsigned char var_fonction =  *( (unsigned char*)pvParameters);
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |=0x10;
	for(;;)
	{ ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0xFF;
		((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = 0x10;
		allume_num_tache(1);
	}
}  
...
static void vLed2Task( void *pvParameters )
{
	...
	( void ) pvParameters;
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |=0x20;
	for(;;)
	{ ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0xFF;
		((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = 0x20;
		allume_num_tache(2);
	}
}  
static void vLed3Task( void *pvParameters )
{
	...
	( void ) pvParameters;
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |=0x40;
	for(;;)
	{ ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0xFF;
		((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = 0x40;
		allume_num_tache(3);
	}
}  
...
static void vLed4Task( void *pvParameters )
{
	...
	( void ) pvParameters;
  ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |=0x80;
	for(;;)
	{ ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0xFF;
		((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = 0x80;
		allume_num_tache(4);
	}
}  
